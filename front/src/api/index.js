...
// 12.加入购物车
export const addGoods2Car = (user_id,goods_id,goods_name,thumb_url,price,sales_tip) => ajax(BASE_URL + '/api/add_shop_car',{user_id,goods_id,goods_name,thumb_url,price,sales_tip},'POST')
...
// 15.删除购物车商品组2
export const delCartGoodsGroup = (goods_ids) => ajax(BASE_URL + '/api/del_car_goods_group',{goods_ids},'POST')
